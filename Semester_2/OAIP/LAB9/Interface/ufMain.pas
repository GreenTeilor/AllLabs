...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.ComCtrls, Vcl.StdCtrls, unTypes, ufAdd, ufEdit, ufExpired, ufSearch;
...
//Open search form
procedure TFormMain.btSearchClick(Sender: TObject);
begin
  FormSearch.ShowModal;
end;

//Print appliances in groups sorted by return date
procedure TFormMain.btSortClick(Sender: TObject);
begin
  PrintConditions(head, tail, lvList);
end;
