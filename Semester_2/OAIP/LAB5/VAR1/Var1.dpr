...
function addMatrix(const Mtrx1, Mtrx2): mas;
var
  i, j: integer;
  temp1: mas;
  X: mas absolute Mtrx1;
  Y: mas absolute Mtrx2;
{ X - matrix 1
  Y - matrix 2
  temp1 - result
  i - counter 1
...
function subMatrix(const Mtrx1, Mtrx2): mas;
var
  i, j: integer;
  temp2: mas;
  X: mas absolute Mtrx1;
...
function multNum(const numAddr, Mtrx): mas;
var
  i, j: integer;
  temp3: mas;
  num: integer absolute numAddr;
  X: mas absolute Mtrx;
{ X - matrix 1
  Y - matrix 2
  temp3 - result
...
function multMatrix(const Mtrx1, Mtrx2): mas;
var
  i, j, k: integer;
  temp4: mas;
  X: mas absolute Mtrx1;
...
//Output matrix
procedure outputMatrix(const Mtrx: mas);
var
  i, j: integer;
  X: mas absolute Mtrx;
{ X - matrix
