...
function addMatrix(const X, Y: mas): mas;
var
  i, j: integer;
  temp1: mas;
{ X - matrix 1
...
function subMatrix(const X, Y: mas): mas;
var
  i, j: integer;
  temp2: mas;
{ X - matrix 1
...
function multNum(const num: integer;const X: mas): mas;
var
  i, j: integer;
  temp3: mas;
{ X - matrix 1
...
function multMatrix(const X, Y: mas): mas;
var
  i, j, k: integer;
  temp4: mas;
{ X - matrix 1
...
//Output matrix
procedure outputMatrix(const X: mas);
var
  i, j: integer;
{ X - matrix
  i - counter
