...
HD_PWD='D:/Labs/semester_7/POCP/Lab1/D/D.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log group_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source group_mux.tcl
