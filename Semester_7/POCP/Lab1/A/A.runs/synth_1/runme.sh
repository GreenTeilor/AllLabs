...
HD_PWD='D:/Labs/semester_7/POCP/Lab1/A/A.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log or_element.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source or_element.tcl
