...
HD_PWD='D:/Labs/semester_7/POCP/Lab1/A/A.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log or_element.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source or_element.tcl -notrace
