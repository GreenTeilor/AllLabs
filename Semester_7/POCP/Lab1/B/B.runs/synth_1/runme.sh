...
HD_PWD='D:/Labs/semester_7/POCP/Lab1/B/B.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_function.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_function.tcl
