...
HD_PWD='D:/Labs/semester_7/POCP/Lab1/C/C.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log additional_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source additional_out.tcl
