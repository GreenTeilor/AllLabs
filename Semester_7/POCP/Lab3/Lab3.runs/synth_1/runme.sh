...
HD_PWD='D:/Labs/semester_7/POCP/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RS_latch_behavioral.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RS_latch_behavioral.tcl
