                                    ...
                                    <div class="carousel-inner">
                                        <c:forEach items="${product.getImages()}" var="image" varStatus="status">
                                            <div class="carousel-item ${status.first ? 'active' : ''}">
                                                <img src="<c:url value="/${image.getPath()}"/>" class="card-img-top d-block"
                                                     style="height: 25rem;">
                                            </div>
                                        </c:forEach>
                                    </div>
        ...
        <div class="pagination-management">
            <nav class="pagination-nav">
                <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link"
                                             href="<c:url value="/categories/${categoryName}/paging?pageNumber=0"/>">1</a>
                    </li>
                    <li class="page-item"><a class="page-link"
                                             href="<c:url value="/categories/${categoryName}/paging?pageNumber=1"/>">2</a>
                    </li>
                    <li class="page-item"><a class="page-link"
                                             href="<c:url value="/categories/${categoryName}/paging?pageNumber=2"/>">3</a>
                    </li>
                    <li class="page-item"><a class="page-link"
                                             href="<c:url value="/categories/${categoryName}/paging?pageNumber=${params.getPageNumber() + 1}"/>">>></a>
                    </li>
