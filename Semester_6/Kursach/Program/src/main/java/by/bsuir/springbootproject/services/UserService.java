...
public interface UserService extends BaseService<User>{
    ...
    ModelAndView makeOrder(User user, Cart cart) throws InsufficientFundsException, NoProductsInOrderException, NoResourceFoundException, NoProductInInventoryException;
}
