...
public:
	...
	static void rasterTriangle(std::vector<glm::vec4>& vertices, std::vector<glm::vec3>& worldVertices, std::vector<glm::vec3>& normals, std::vector<glm::vec3>& textureVectors, const glm::vec3& cameraPos,
