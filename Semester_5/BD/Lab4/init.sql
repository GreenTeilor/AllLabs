...
/*  Created On : 24-ноя-2023 19:22:39 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
/* Shema creation */
DROP SCHEMA IF EXISTS `bd_lab4` ;
CREATE SCHEMA IF NOT EXISTS `bd_lab4` DEFAULT CHARACTER SET utf8 ;
USE `bd_lab4` ;
...
ALTER TABLE `plane` 
 ADD CONSTRAINT `FK_PLANE_manufaction_corporation_id`
	FOREIGN KEY (`manufaction_corporation_id`) REFERENCES `corporation` (`id`) ON DELETE Set Null ON UPDATE Set Null
;
