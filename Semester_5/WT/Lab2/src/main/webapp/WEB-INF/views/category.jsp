...
<html>
<head>
    <title>${requestScope.categoryName}</title>
...
<div class="wrapper">
    ...
    <div class="main">
        <div class="container-fluid products">
            <div class="row">
                <c:forEach items="${requestScope.categoryProducts}" var="product">
            ...
            <nav class="pagination-nav">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link"
                                             href="<c:url value="/categories/${requestScope.categoryName}/paging?pageNumber=${sessionScope.productPagingParams.getPageNumber() - 1}"/>"><<</a>
                    </li>
                    <li class="page-item"><a class="page-link"
                                             href="<c:url value="/categories/${requestScope.categoryName}/paging?pageNumber=0"/>">1</a>
                    </li>
                    <li class="page-item"><a class="page-link"
                                             href="<c:url value="/categories/${requestScope.categoryName}/paging?pageNumber=1"/>">2</a>
                    </li>
                    <li class="page-item"><a class="page-link"
                                             href="<c:url value="/categories/${requestScope.categoryName}/paging?pageNumber=2"/>">3</a>
                    </li>
                    <li class="page-item"><a class="page-link"
                                             href="<c:url value="/categories/${requestScope.categoryName}/paging?pageNumber=${sessionScope.productPagingParams.getPageNumber() + 1}"/>">>></a>
                    </li>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <c:forEach begin="1" end="9" var="pageSize">
                        <a class="dropdown-item"
                           href="<c:url value="/categories/${requestScope.categoryName}/paging?pageSize=${pageSize}"/>">${pageSize}</a>
                    </c:forEach>
                </div>
            </div>
        </div>
