 ...
 * {@link #handle(jakarta.servlet.http.HttpServletRequest, jakarta.servlet.http.HttpServletResponse)} as follows:</p>
 *
 * <blockquote><pre>
 ...
 * </pre></blockquote>
 * <p>
 * When you call {@link #handle(jakarta.servlet.http.HttpServletRequest, jakarta.servlet.http.HttpServletResponse)} method, your matching
 ...
 * You should check for {@code ServletUrl.NOT_FOUND} and send {@link jakarta.servlet.http.HttpServletResponse#SC_NOT_FOUND} manually.
 * <p>
 * <br>
...
public class ServletUrlPattern {
	 ...
	 *
	 * <p>This method is NOT thread-safe. Should only be called from a {@code constructor} or {@link jakarta.servlet.http.HttpServlet#init()} or called
	 ...
	 *
	 * @param url It should be {@link jakarta.servlet.http.HttpServletRequest#getPathInfo()}
	 * @return Copy of the matched {@code ServletUrl} or a special instance of ServletUrl whose name is {@link ServletUrl#NOT_FOUND_404}
	 */
	@NotNull
