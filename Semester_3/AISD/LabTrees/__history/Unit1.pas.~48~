...
begin
  ...
  //Tree traversals
  lblPram.Caption:= 'Прямой обход: ' + directTraversial(rootElem);
  lblObr.Caption:='Обратный обход: '+reversiveTraversial(rootElem);
  lblSim.Caption:='Симметричный обход: ' + symmetricalTraversial_andThreading(rootElem,bmp);
